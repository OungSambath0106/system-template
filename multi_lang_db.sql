...
--
-- Host: localhost
-- Generation Time: Sep 07, 2023 at 12:11 PM
...
(1, 'language', '[{\"id\":\"1\",\"name\":\"english\",\"direction\":\"ltr\",\"code\":\"en\",\"status\":1,\"default\":true}]', NULL, NULL),
(2, 'pnc_language', '[\"en\"]', NULL, NULL);
...
CREATE TABLE `products` (
  ...
  `discount_type` varchar(191) NOT NULL DEFAULT 'percent',
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `first_name`, `last_name`, `phone`, `telegram`, `image`, `deleted_at`, `user_id`) VALUES
(1, 'superadmin', 'admin@gmail.com', NULL, '$2y$10$78nrUBLUIqOO0lWLNWCCde1Njlk4Vdq90Bh6SaevJFCIDJr0xGe5K', NULL, '2023-09-07 10:11:02', '2023-09-07 10:11:02', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
