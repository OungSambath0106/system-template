                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 ">
                                        ...
                                        <input type="number" name="sort_order" id="sort_order" min="1" max="100" class="form-control @error('sort_order') is-invalid @enderror"
                                            step="any" value="{{ old('sort_order') }}"></input>
                                        @error('sort_order')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
