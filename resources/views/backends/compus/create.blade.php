    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-12">
                    <!-- /.card-header -->
                    <form method="POST" action="{{ route('admin.compus.store') }}" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 ">
                                        ...
                                        <input type="text" name="telegram_url" id="telegram_url"
                                            ...
                                            step="any" value="{{ old('telegram_url') }}">
                                        @error('telegram_url')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group col-md-12 ">
                                        ...
                                        <textarea name="google_map_url" id="google_map_url"
                                            class="form-control @error('google_map_url') is-invalid @enderror" step="any" rows="2"
                                            value="{{ old('google_map_url') }}"></textarea>
