                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <h3 class="card-title">{{ __('Campus List') }}</h3>
                            </div>
                            {{-- <span class="badge bg-warning total-count">{{ $grades->total() }}</span> --}}
                            <div class="col-sm-6">
                                {{-- <a href="{{ au }}"></a> --}}
                                <a class="btn btn-primary float-right" href="{{ route('admin.compus.create') }}">
                    ...
                    {{-- table --}}
                    @include('backends.compus._table')
...
<script>
    ...
    $('input.status').on('change', function () {
        ...
        $.ajax({
            type: "get",
            url: "{{ route('admin.compus.update_status') }}",
