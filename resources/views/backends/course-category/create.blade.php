                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputFile">{{ __('Curriculum Image') }}</label>
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="hidden" name="curriculum_images"
                                                        class="curriculum_image_hidden">
                                                    <input type="file" class="custom-file-input curriculum-file-input"
                                                        id="exampleInputFile" name="curriculum_image"
                                                        accept="image/png, image/jpeg">
                                                    <label class="custom-file-label"
                                                        for="exampleInputFile">{{ __('Curriculum Image') }}</label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputFile">{{ __('Assessment Detail') }}</label>
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="hidden" name="assessment_details"
                                                        class="assessment_hidden">
                                                    <input type="file" class="custom-file-input assessment-file-input"
                                                        id="exampleInputFile" name="assessment_detail"
                                                        accept="image/png, image/jpeg">
                                                    <label class="custom-file-label"
                                                        for="exampleInputFile">{{ __('Assessment Detail') }}</label>
                                                </div>
                                            </div>
                                            <div class="preview preview-multiple text-center border rounded mt-2"
                                                style="height: 150px">
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputFile">{{ __('Mobile app icon') }}</label>
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="hidden" name="icons" class="icon_hidden">
                                                    <input type="file" class="custom-file-input icon-file-input"
                                                        id="exampleInputFile" name="icon"
                                                        accept="image/png, image/jpeg">
                                                    <label class="custom-file-label"
                                                        for="exampleInputFile">{{ __('Mobile app icon') }}</label>
                                                </div>
                                            </div>
                                            <div class="preview preview-multiple text-center border rounded mt-2"
                                                style="height: 150px">
