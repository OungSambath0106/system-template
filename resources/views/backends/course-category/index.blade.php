                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <h3 class="card-title">{{ __('Course Category List') }}</h3>
                            </div>
                            {{-- <span class="badge bg-warning total-count">{{ $grades->total() }}</span> --}}
                            <div class="col-sm-6">
                                <a class="btn btn-primary float-right" href="{{ route('admin.course-category.create') }}">
                    ...
                    {{-- table --}}
                    @include('backends.course-category._table')
