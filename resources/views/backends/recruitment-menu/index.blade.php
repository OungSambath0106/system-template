                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <h3 class="card-title">{{ __('Recruitment List') }}</h3>
                            </div>
                            {{-- <span class="badge bg-warning total-count">{{ $grades->total() }}</span> --}}
                            <div class="col-sm-6">
                                <a class="btn btn-primary float-right" href="{{ route('admin.recruitment.create') }}">
                    ...
                    {{-- table --}}
                    @include('backends.recruitment-menu._table')
...
<script>
    ...
    $('input.status').on('change', function () {
        ...
        $.ajax({
            type: "post",
            url: "{{ route('admin.recruitment.update_status') }}",
