                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="tab-content" id="custom-content-below-tabContent">
                                            @foreach (json_decode($language, true) as $lang)
                                                @if ($lang['status'] == 1)
                                                    <?php
                                                    if (count($student['translations'])) {
                                                        $translate = [];
                                                        foreach ($student['translations'] as $t) {
                                                    ...
                                                    <div class="tab-pane row fade {{ $lang['code'] == $default_lang ? 'show active' : '' }} mt-3"
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input type="title" id="title_{{ $lang['code'] }}"
                                                                ...
                                                                value="{{ $translate[$lang['code']]['title'] ?? $student['title'] }}">
                                                            @error('title')
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea id="description_{{ $lang['code'] }}" class="form-control @error('description') is-invalid @enderror"
                                                                name="description[]" rows="2">{{ $translate[$lang['code']]['description'] ?? $student['description'] }}</textarea>
                                                            @error('description')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="preview preview-multiple text-center border rounded mt-2"
                                                style="height: 150px">
                                                <img src="{{ asset('uploads/studen-report/' . $student->image) }}"
                                                    alt="" height="100%">
                                            </div>
                                        </div>
                                    </div>
